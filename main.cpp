...
static const char* NamesFile = "/Users/fyva/Desktop/hw1/hw1cpp/hw1cpp/Birds.txt"; // http://www.jimpalt.org/birdwatcher/name.html 941 names of different birds, ASCII code, OD OA after each row
...
void PrepareNames()
{
    ...
    if (!file.good())
        throw std::runtime_error("Unable to open the names file");
    char buf[100];
    while (file.good())
    {
